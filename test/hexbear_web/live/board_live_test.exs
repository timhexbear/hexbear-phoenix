defmodule HexbearWeb.BoardLiveTest do
  ...
  @create_attrs %{comments_closed: true, description: "some description", is_private: true, name: "some name", threads_closed: true, title: "some title"}
  ...
  defp fixture(:board) do
    {:ok, board} = Local.create_board(@create_attrs)
    board
  end
